...
var _process_hostile_action_fn: Callable
...
func configure(
		...
		process_hostile_action_fn: Callable,
	...
	_process_hostile_action_fn = process_hostile_action_fn
...
func _connect_bus() -> void:
	...
	if not _event_bus.hostile_acted.is_connected(_on_any_hostile_acted):
		_event_bus.hostile_acted.connect(_on_any_hostile_acted)
...
func _on_any_hostile_acted() -> void:
	if _process_hostile_action_fn.is_valid():
		_process_hostile_action_fn.call()
